...
public class SnakeLadder extends Application {
   ...
   root.getChildren().addAll(tileGroup);
        ...
        randomResult = new Label("Start the Game");
        randomResult.setTranslateX(150);
        randomResult.setTranslateY(yLine-20);
        ...
        Image img = new Image("C:\\Users\\Asus\\IdeaProjects\\Snake and Ladder\\src\\SnakeLadderBoard12Nov.jpg");
        ImageView boardImage = new ImageView();
        boardImage.setImage(img);
        boardImage.setFitWidth(tileSize*width);
        boardImage.setFitHeight(tileSize*height);

       tileGroup.getChildren().addAll(boardImage,playerOneButton,gameButton,
               playerTwoButton,randomResult,playerOne.getGamePiece(),playerTwo.getGamePiece());
    ...
    private void getDiceValue(){
        ...
        randomResult.setText(Integer.toString(diceValue));
    }
